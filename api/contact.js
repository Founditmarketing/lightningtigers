...
—
Sent from the contact form on lightningtigers.com`;
  const html = `
<h2>New lead from Lightning Tigers</h2>
...
<p style="color:#666;font-size:13px">Sent from the contact form on lightningtigers.com</p>`;
